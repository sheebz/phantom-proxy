(function (exports) {
    ...
    //kill orphaned phantom processes
    process.on('exit', function () {
        phantomProcesses.forEach(function (process, index) {
            try {
                process.kill('SIGHUP');
    ...
    var phantomProxy = _.extend({}, {
        ...
        getStatus:function () {
            return {
                serverPid:(phantomProcess && phantomProcess.pid) || undefined
            }
        },
...
//            });
        ...
        createServer:function (port, callbackFn) {
            ...
            phantomProcesses.push(phantomProcess);
