...
(function (module, phantom) {
    ...
    module.exports = {
        create:function (options) {
            ...
            this.eventWriter = require('./eventWriter').create(options);

            //add global error handling
            this.bindEvents(this.eventWriter);
            return this;
        },
        ...
        exit:function (returnCode) {
            ...
            this.eventWriter.triggerEvent('phantom', {
                type:'exited',
                args:
                    [
                        returnCode
        ...
        bindEvents:function (eventWriter) {
            phantom.onError = function (msg, trace) {
                ...
                eventWriter.triggerEvent('phantom', event);
            };
        }
    };
}(module, phantom));
