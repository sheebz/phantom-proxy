...
//properties
        ...
        waitForSelector:function (selector, callbackFn, timeout) {
            ...
            timeout = timeout || 2000;//default timeout is 2 sec
            ...
            this.evaluate(function (selectorToEvaluate) {
                ...
                if (result == 0) {
                    try {
                        var newTimeout = timeout - timeoutInterval;
                        ...
                        //if no timeout, then invoke again in x ms.
                        setTimeout.call(self,
                            (function () {
                                self.waitForSelector(selector, callbackFn, newTimeout);
                            }(self))
                            , timeoutInterval);
                    }
                    catch (error) {
